...
static void MX_GPIO_Init(void) {
	...
	motor_ena_negatif_Pin | motor_dir_Pin | motor_pulse_Pin, GPIO_PIN_RESET);

	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(motor_ena_pozitif_GPIO_Port, motor_ena_pozitif_Pin,
			GPIO_PIN_SET);

	/*Configure GPIO pins : motor_ena_negatif_Pin motor_ena_pozitif_Pin motor_dir_Pin motor_pulse_Pin */
	GPIO_InitStruct.Pin = motor_ena_negatif_Pin | motor_ena_pozitif_Pin
			| motor_dir_Pin | motor_pulse_Pin;
